...
urlpatterns = [
    ...
    path('agregar-al-carrito/', views.agregar_al_carrito, name="agregaralcarrito"),
    path('eliminar-del-carrito/<int:id_item>/', views.eliminar_del_carrito, name='eliminar_del_carrito'),
